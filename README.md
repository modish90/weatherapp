...
- [Moshi](https://github.com/square/moshi) - Moshi Parser, used to parse requests on the data layer for Entities and understands Kotlin non-nullable and default parameters.
